...
**Plans:** 5, written 2026-09-17 (`22-01-PLAN.md` … `22-05-PLAN.md`). Fact-checked and revised the same day. The user decided P3 and P7 (both as recommended) and approved 22-05's live repository. Merged as `ac95151` (PR #47). 22-01 is executed and in review.
...
| 22. pgvector Storage & the First Real Repository | v1.0 | 1/5 | In progress: plans merged as `ac95151` (PR #47); 22-01 executed, in review | - |
