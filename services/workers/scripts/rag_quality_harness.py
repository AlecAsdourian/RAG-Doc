...
Ranking knobs read from the environment by the library, and so usable here:
FTS_RANK_NORMALIZATION, RRF_FTS_WEIGHT, RRF_VECTOR_WEIGHT, and the BOOST_* vars
in QueryEngine. --boost-config reaches every MetadataBooster weight, including
the ones no env var exposes.
